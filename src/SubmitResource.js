    ...
    <div className="bg-gray-50 ">
      <div className="w-2/4 m-auto text-center">
        <div className="my-5">
          ...
          <p id="form-error-message" className="mt-1 text-red-600">
            {errorMessage}
          </p>
          <p id="form-success-message" className="mt-1">
            {successMessage}
          </p>
        </div>
        <form
        ...
        >
          <label htmlFor="resource-name">Resource Name (required):</label>
          <br />
          <input
            type="text"
            id="resource-name"
            aria-required="true"
            aria-invalid={resourceValid ? "false" : "true"}
